                    ...
                    >
                      ...
                      <FormLabel className={classes.formLabel}>
                        <Field
                          type="radio"
                          name="whereHeardAbout"
                          value="CEGEP Gérald Godin Website"
                        />
                        <Typography variant="subtitle1">
                          CEGEP Gérald Godin Website
                        </Typography>
                      </FormLabel>
                      ...
                      <FormLabel className={classes.formLabel}>
                        <Field
                          type="radio"
                          name="whereHeardAbout"
                          value="CEGEP Gérald Godin Continuing Education newsletter"
                        />
                        <Typography variant="subtitle1">
                          CEGEP Gérald Godin Continuing Education newsletter
                        </Typography>
                      </FormLabel>
